...
public class AutoListForScrollView extends ListView implements OnScrollListener {
	...
	public AutoListForScrollView(Context context) {
		super(context);
		initView(context);
	}

	public AutoListForScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public AutoListForScrollView(Context context, AttributeSet attrs, int defStyle) {
