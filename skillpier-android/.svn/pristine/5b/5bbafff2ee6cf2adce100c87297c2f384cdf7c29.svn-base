...
import com.quark.api.auto.bean.AddCourseCertificationRequest;
 ...
 * 新增证书
 */
public class CertificationsActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public void cd(View b) {
        switch (b.getId()) {
            case R.id.new_image_ibt:
                ImageUtils.showSheetPic(CertificationsActivity.this, handlerphoto);
                break;
    ...
    public void addCourseCertificationRequest() {
        AddCourseCertificationRequest rq = new AddCourseCertificationRequest();
    ...
    private final AsyncHttpResponseHandler mHandler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
            Object kd = ApiResponse.get(arg2, CertificationsActivity.this, AddCourseCertificationResponse.class);
            if (kd != null) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 101:
                    ...
                    Date date = null;
                    try {
                        date = new SimpleDateFormat("yyyy-MM-dd").parse(get_time);
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
                    // 将date转化为String
                    String s = new SimpleDateFormat("MMM d, yyyy", Locale.ENGLISH).format(date);
                    choosetimeTv.setText(s);
                    break;
                default:
                    break;
            }
        ...
        if (resultCode != 0) {
            switch (requestCode) {
                case ImageUtils.IMAGE_REQUEST_CODE:
                    ...
                    newRemoveIbt.setVisibility(View.VISIBLE);
