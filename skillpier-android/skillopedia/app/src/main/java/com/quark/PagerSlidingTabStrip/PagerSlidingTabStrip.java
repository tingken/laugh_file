package com.quark.PagerSlidingTabStrip;
...
//        private int dividerColor = 0x1A000000;
    ...
    private int indicatorColor = 0xFF666666;
    private int underlineColor = 0x1A000000;
    private int dividerColor = 0000000000;
        ...
        private int selectedTabTextSize=13;//选中修改字体大小
        ...
        public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
            ...
            selectedTabTextSize=a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_zmsSelectedTabTextSize, tabTextSize);//修改默认
