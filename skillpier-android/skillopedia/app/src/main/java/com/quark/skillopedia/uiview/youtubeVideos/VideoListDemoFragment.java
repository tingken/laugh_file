 ...
 */
@TargetApi(13)
public final class VideoListDemoFragment extends Fragment implements OnFullscreenListener {
  ...
  View vedioView;
  public static VideoListDemoFragment instance;
  @Override
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    vedioView = inflater.inflate(R.layout.video_list_demo_fragment, container, false);
//    setContentView(R.layout.video_list_demo);

    FragmentManager fmg = getChildFragmentManager();
      instance = this;

    listFragment = (VideoListFragment) fmg.findFragmentById(R.id.list_fragment);
    videoFragment = (VideoFragment) getFragmentManager().findFragmentById(R.id.video_fragment_container);

    videoBox = vedioView.findViewById(R.id.video_box);
    closeButton = vedioView.findViewById(R.id.close_button);
...
//      recreate();
  ...
  public static final class VideoFragment extends YouTubePlayerFragment
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean restored) {
      ...
      player.setOnFullscreenListener(VideoListDemoFragment.instance);
