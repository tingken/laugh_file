 ...
 * >#
 */
public class CouponExpAdapter extends BaseSwipeAdapter {

    private Context context;
    private List<ListMyCoupon> list;
    Handler handler;

    public CouponExpAdapter(Context context, List<ListMyCoupon> list, Handler handler) {
    ...
    public View generateView(int position, ViewGroup parent) {
        View v = LayoutInflater.from(context).inflate(R.layout.exp_conpon_list, null);
        return v;
    }
